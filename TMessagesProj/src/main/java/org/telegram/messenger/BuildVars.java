...
public class BuildVars {
    ...
    public static int APP_ID = 0; // get your own at https://core.telegram.org/api/obtaining_api_id
    public static String APP_HASH = ""; // get your own at https://core.telegram.org/api/obtaining_api_id
